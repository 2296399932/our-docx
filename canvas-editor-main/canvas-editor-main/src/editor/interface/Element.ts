...
export type IElement = IElementBasic &
  ...
  IParagraphElement &
  {
    spaceBefore?: { value: number, unit: 'px' | 'pt' | 'cm' }
    spaceAfter?: { value: number, unit: 'px' | 'pt' | 'cm' }
    lineSpacingMode?: 'multiple' | 'exactly' | 'atLeast'
    lineSpacingValue?: { value: number, unit: 'px' | 'pt' | 'cm' | 'multiple' }
  }
